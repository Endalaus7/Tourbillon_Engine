...
//注册反射类（静态）
#define REGISTER_STATIC_REFLECT(class_name)\
...
//
#define STATIC_PROPERTY_DEF_IMPL(N) CONNECT(STATIC_PROPERTY_DEF_, N)
#define STATIC_PROPERTY_DEF(...)EXPAND(STATIC_PROPERTY_DEF_IMPL(GET_ARG_COUNT(__VA_ARGS__))(__VA_ARGS__))


#define STATIC_PROPERTY_DEF_2(argtype, argname)\
    public:\
        argtype argname;     \
    private:\
...
#define STATIC_PROPERTY_DEF_3(argtype, argname, value)\
    public:\
